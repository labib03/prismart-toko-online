...
export const ProductCard: React.FC<ProductCardProps> = ({ product, onOpenDetail }) => {
  ...
  return (
    <div
      ...
      className="hallmark-card rounded-2xl overflow-hidden flex flex-col group cursor-pointer bg-white border border-slate-200/80 hover:shadow-lg transition-all duration-200"
    >
      {/* Image & Stock Badge */}
