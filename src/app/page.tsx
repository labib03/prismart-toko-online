...
export default function HomePage() {
  ...
  const fetchProducts = async (query = '') => {
    ...
    try {
      ...
      const res = await apiRequest<{ products: (Product & { avgRating?: number; reviewCount?: number })[] }>(endpoint);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      ...
      <section className="hero-gradient border border-slate-200/80 rounded-3xl p-8 sm:p-14 text-center mb-10 shadow-xs relative overflow-hidden bg-gradient-to-b from-white to-slate-50">
