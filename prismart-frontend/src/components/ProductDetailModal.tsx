...
import { X, Star, ShoppingCart, Check, MessageSquare, AlertCircle, User as UserIcon, Send } from 'lucide-react';
...
export const ProductDetailModal: React.FC<ProductDetailModalProps> = ({
  ...
  useEffect(() => {
    ...
    const fetchReviews = async () => {
      ...
      try {
        const res = await apiRequest<ReviewItem[]>(`/products/${product.id}/reviews`);
